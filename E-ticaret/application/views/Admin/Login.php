...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>EvSera.com Admin</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Evsera " name="description" />
                ...
                <div class="col-md-6 login-container bs-reset">
                    ...
                    <div class="login-content">
                        ...
                        <form action="<?=base_url() ?>Admin/Login/Login" class="login-form" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="Email"  autocomplete="off" placeholder="Email giriniz." name="Email" required/> </div>
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Şifre giriniz" name="Sifre" required/> </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
